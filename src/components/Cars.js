    ...
    renderItems = (item) => {
        return(
            <Animatable.View animation="fadeInUp" easing="ease-out" delay={600}>
                <TouchableOpacity onPress={() => this.props.navigation.navigate(this.props.user ? 'carDetails' : 'login' , { user_id: item.user_id, backRoute:'cars' ,catType:this.props.navigation.state.params.catType , isLoader:false})} style={[styles.eventTouch ]}>
