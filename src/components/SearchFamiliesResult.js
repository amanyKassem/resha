...
class SearchFamiliesResult extends Component {
    constructor(props){
        super(props);
    ...
    renderItems = (item) => {
        return(
            <TouchableOpacity onPress={ () => this.props.navigation.navigate('familyDetails' , {user_id: item.user_id , backRoute:'searchFamiliesResult'})} style={[styles.notiBlock , styles.directionRow]}>
            ...
            <Container>
                ...
                <Header style={[styles.header]} noShadow>
                    <Animated.View style={[ styles.animatedHeader ,{ backgroundColor: backgroundColor}]}>
                        ...
                        <TouchableOpacity disabled onPress={ () => this.props.navigation.navigate('familyFilter' , {backRoute:'searchFamiliesResult'})} style={styles.headerBtn}>
...
export default SearchFamiliesResult;