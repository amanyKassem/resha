...
import {getTypeCategories, getUpdateProduct} from "../actions";
            ...
            <Container>
                ...
                <Header style={[styles.header]} noShadow>
                    ...
                    <Animated.View style={[ styles.animatedHeader ,{ backgroundColor: backgroundColor}]}>
                        ...
                        <Text style={[styles.headerText , {right:20}]}>{ i18n.t('editProduct') }</Text>
...
const mapStateToProps = ({ lang , typeCategories , storeProduct , profile}) => {
    return {
        ...
        updateProduct: storeProduct.updateProduct,
        user: profile.user,
        key:storeProduct.key
    };
};
export default connect(mapStateToProps, {getTypeCategories , getUpdateProduct})(EditProduct);
