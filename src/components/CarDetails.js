                    ...
                    <ImageBackground source={require('../../assets/images/bg_app.png')} resizeMode={'cover'} style={styles.imageBackground}>
                        <View style={[styles.homeSection , styles.whiteHome , {paddingHorizontal:20 , paddingVertical:20} ]}>
                            <View style={styles.directionRowSpace}>
                                <Text style={[styles.boldGrayText , styles.normalText , styles.mb10]}>اسم العربة</Text>
                            ...
                            <Swiper dotStyle={styles.eventdoteStyle} activeDotStyle={styles.eventactiveDot}
                                ...
                                <Image source={require('../../assets/images/image_car.png')} style={styles.swiperImg} resizeMode={'cover'}/>
