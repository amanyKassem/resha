        ...
        if(this.state.active === 0 ){
                ...
                <View style={styles.directionColumn}>
                    <View style={[styles.directionRowSpace , {flexWrap:'wrap'}]}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('restProductDetails')}>
                            <Image source={require('../../assets/images/image_car.png')} style={styles.productImg} resizeMode={'cover'}/>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('restProductDetails')}>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('carProducts')} style={[styles.delAcc , {backgroundColor:COLORS.white}]}>
            ...
            return(
                <View style={styles.directionColumn}>
                    ...
                    <TouchableOpacity style={styles.floatingEdit} onPress={() => this.props.navigation.navigate('editCarContact')}>
                        <Image source={require('../../assets/images/edit_floting.png')} style={styles.editImg} resizeMode={'contain'}/>
                    </TouchableOpacity>
                </View>
            )
            ...
            <Container>
                ...
                <Header style={[styles.header]} noShadow>
                    <Animated.View style={[ styles.animatedHeader ,{ backgroundColor: backgroundColor}]}>
                        ...
                        <Text style={[styles.headerText , {right:20}]}>اسم العربة</Text>
                ...
                <Content  contentContainerStyle={styles.flexGrow} style={styles.homecontent}  onScroll={e => this.headerScrollingAnimation(e) }>
                    <ImageBackground source={require('../../assets/images/bg_app.png')} resizeMode={'cover'} style={styles.imageBackground}>
                        <View style={[styles.homeSection , styles.whiteHome , {paddingHorizontal:0 , paddingTop:20} ]}>
                            ...
                            <Image source={require('../../assets/images/image_car.png')} style={styles.restImg} resizeMode={'cover'}/>
                            ...
                            <Text style={[styles.grayText , styles.normalText , styles.writing , styles.asfs , {fontSize:13, paddingHorizontal:20}]}>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى،</Text>
