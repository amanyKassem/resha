        ...
        if(this.state.active === 0 ){
            return(
                <View style={styles.directionColumn}>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('carProducts', {user_id :this.props.showProfile.user_id})} style={[styles.delAcc , {backgroundColor:COLORS.white}]}>
