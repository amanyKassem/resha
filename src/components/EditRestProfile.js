...
import {getTypeCategories , getUpdateProfileMain} from "../actions";
...
class EditRestProfile extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        console.log('nextProps.updateProfileMain' , nextProps.updateProfileMain)
    }

    submitData(){
        this.setState({ isSubmitted: true });
        this.props.getUpdateProfileMain( this.props.lang , this.state.restName , this.state.moreDet , this.state.mapRegion.latitude , this.state.mapRegion.longitude ,
            this.state.category , this.state.location , this.state.base64 , this.props.user.token , this.props , 'myResturant')
    }
            ...
            <Container>
                ...
                <Header style={[styles.header]} noShadow>
                    ...
                    <Animated.View style={[ styles.animatedHeader ,{ backgroundColor: backgroundColor}]}>
                        ...
                        <Text style={[styles.headerText , {right:20}]}>{ i18n.t('editRest') }</Text>
...
const mapStateToProps = ({ lang , typeCategories , updateProfileMain , profile}) => {
    return {
        ...
        updateProfileMain: updateProfileMain.updateProfileMain,
        user: profile.user,
        key:updateProfileMain.key
    };
};
export default connect(mapStateToProps, {getTypeCategories , getUpdateProfileMain})(EditRestProfile);
