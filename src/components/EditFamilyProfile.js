...
import {getTypeCategories , getUpdateFamilyProfileMain} from "../actions";
...
class EditFamilyProfile extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        console.log('nextProps.updateFamilyProfileMain' , nextProps.updateFamilyProfileMain)
    }
...
const mapStateToProps = ({ lang , typeCategories , updateProfileMain , profile}) => {
    return {
        ...
        updateFamilyProfileMain: updateProfileMain.updateFamilyProfileMain,
        user: profile.user,
        key:updateProfileMain.key
    };
};
export default connect(mapStateToProps, {getTypeCategories , getUpdateFamilyProfileMain})(EditFamilyProfile);