                ...
                <Header style={[styles.header]} noShadow>
                    ...
                    <Animated.View style={[ styles.animatedHeader ,{ backgroundColor: backgroundColor}]}>
                        <Right style={styles.flex0}>
                            <TouchableOpacity  onPress={() => this.props.navigation.navigate('restProducts')} style={styles.headerBtn}>
                            ...
                            this.props.showProduct?
                                <View style={[styles.homeSection , styles.whiteHome , {paddingHorizontal:20 , paddingVertical:20} ]}>
                                    ...
                                    <TouchableOpacity style={styles.floatingEdit} onPress={() => this.props.navigation.navigate('editProduct' , {product_id:this.props.navigation.state.params.product_id,
                                        prodName :this.props.showProduct.name ,category_id :this.props.showProduct.category_id ,
                                        price:this.props.showProduct.price , moreDet: this.props.showProduct.details ,images:this.props.showProduct.images, backRoute:'restProductDetails'})}>
