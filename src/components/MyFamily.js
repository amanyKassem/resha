        ...
        if(this.state.active === 0 ){
                ...
                <View style={styles.directionColumn}>
                    <View style={[styles.directionRowSpace , {flexWrap:'wrap'}]}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('restProductDetails')}>
                            <Image source={require('../../assets/images/factory.jpg')} style={styles.productImg} resizeMode={'cover'}/>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate('restProductDetails')}>
                    ...
                    <TouchableOpacity onPress={() => this.props.navigation.navigate('familyProducts')} style={[styles.delAcc , {backgroundColor:COLORS.white}]}>
            ...
            return(
                <View style={styles.directionColumn}>
                    ...
                    <TouchableOpacity style={styles.floatingEdit} onPress={() => this.props.navigation.navigate('editFamilyContact')}>
                        <Image source={require('../../assets/images/edit_floting.png')} style={styles.editImg} resizeMode={'contain'}/>
                    </TouchableOpacity>
                </View>
            )
            ...
            <Container>
                ...
                <Header style={[styles.header]} noShadow>
                    <Animated.View style={[ styles.animatedHeader ,{ backgroundColor: backgroundColor}]}>
                        ...
                        <Text style={[styles.headerText , {right:20}]}>اسم الاسرة</Text>
                ...
                <Content  contentContainerStyle={styles.flexGrow} style={styles.homecontent}  onScroll={e => this.headerScrollingAnimation(e) }>
                    <ImageBackground source={require('../../assets/images/bg_app.png')} resizeMode={'cover'} style={styles.imageBackground}>
                        <View style={[styles.homeSection , styles.whiteHome , {paddingHorizontal:0 , paddingTop:20} ]}>
                            ...
                            <Image source={require('../../assets/images/factory.jpg')} style={styles.restImg} resizeMode={'cover'}/>
